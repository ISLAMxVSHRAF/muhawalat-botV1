...
const NUDGE_MESSAGES = {
    zero: [
        'إزيك يا {name}؟ 🧡\n\nلاحظنا إنك مش معانا الفترة الأخيرة — {count} تقارير في آخر {days} أيام.\n\nمش عارفين إيه اللي وقفك، بس حبينا نطمن عليك 🌱\nحتى لو يومك كان صعب — تقرير صغير بيفرق وبيفرحنا.\n\nمستنيين نسمع عنك! �\n— فريق محاولات 🌿',

        'إزيك يا {name}؟ 🧡\n\nبنتابعك من بعيد ومفتقدين تقاريرك — {count} تقارير في آخر {days} أيام.\n\nسؤال واحد بس: "أنجزت إيه النهارده؟" 🌿\nولو الإجابة "مش كتير" — ده كمان تقرير يستاهل يتكتب.\n\nإحنا هنا معاك 💛\n— فريق محاولات',

        'إزيك يا {name}؟ 🧡\n\n{count} تقارير في آخر {days} أيام — وده وقفنا وفكرنا فيك.\n\nمش بنحكم، بس بنسأل: في حاجة وقفتك؟ محتاج دعم؟\nمجتمع محاولات موجود عشان نكمل مع بعض 🌿\n\nمستنيين عودتك القوية! 🔥\n— فريق محاولات',
    ],
    danger: [
        'إزيك يا {name}؟ 🧡\n\nأسبوعك شوية متقطع الفترة دي — {count} تقارير في آخر {days} أيام.\n\nلسه الوقت كافي تعوّض! سؤال واحد:\n"ناوي تعمل إيه بكرة؟" 🌿\n\nاكتبه في تقريرك وإحنا معاك 💪\n— فريق محاولات',

        'إزيك يا {name}؟ 🧡\n\nlاحظنا إن تقاريرك متقطعة — {count} تقارير في آخر {days} أيام.\n\nالاستمرارية أهم من الكمال — حتى خطوة صغيرة بتفرق 🌱\nإيه اللي تقدر تعمله النهارده؟\n\nإحنا بنتابعك 👀\n— فريق محاولات',

        'إزيك يا {name}؟ 🧡\n\nعارف إن الأيام بتجي صعبة أحياناً 🌧️\n{count} تقارير في آخر {days} أيام — بس لسه عندك فرصة.\n\nحتى في الأيام الصعبة، سؤال واحد:\n"ضيعت وقتك في إيه؟" 😄\n\nنتظر عودتك القوية! 🔥\n— فريق محاولات',
    ],
    good: [
        'إزيك يا {name}؟ 🌟\n\nعاش على مجهودك! {count} تقارير في آخر {days} أيام — ده رقم محترم جداً 💛\n\nالفرق بينك وبين الفئة الأولى صغير — شد كمان شوية!\nكمّل الأسبوع ده وإحنا فخورين بيك 🏆\n\n— فريق محاولات',

        'إزيك يا {name}؟ 🌟\n\n{count} تقارير في آخر {days} أيام — أداء كويس جداً! �\n\nخطوة صغيرة كمان وتبقى في الفئة الأولى.\nإيه اللي ناوي تنجزه النهارده؟ 🌿\n\nمستنيين تقريرك! 💪\n— فريق محاولات',

        'إزيك يا {name}؟ 🌟\n\nالثبات هو السر — و{count} تقارير في آخر {days} أيام بيقول إنك فاهم ده كويس 💛\n\nكمّل على نفس الوتيرة وختم الأسبوع قوي!\n\nإحنا بنتابعك 👀\n— فريق محاولات',
    ]
};
