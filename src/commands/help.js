        ...
        new EmbedBuilder()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: [
                        '`/start_season start_date:` — يبدأ Season جديد مدته 28 يوم، مع تحديد تاريخ البداية بصيغة DD-MM-YYYY.',
                        '`/end_season` — يغلق الـ Season الحالي يدوياً.',
                    ].join('\n'),
                    inline: false
                },
                {
            ...
            .addFields(
                {
                    ...
                    value: [
                        '`/autorespond_add [channels:] [match:]` — يفتح نافذة (Modal) تكتب فيها الكلمة أو الجملة المحفزة ونص الرد، مع إمكانية تحديد القنوات ونوع المطابقة من خيارات الأمر.',
                ...
                },
                {
                    name: '📅 الجدولة',
                    value: [
                        '`/schedule_add channel: repeat:` — يفتح نافذة (Modal) لاختيار وقت الإرسال، العنوان، نص الرسالة، ورابط الميديا، ثم يضيف رسالة مجدولة (يومي/أسبوعي/مرة واحدة).',
