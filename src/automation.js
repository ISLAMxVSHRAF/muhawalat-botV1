...
class AutomationSystem {
    ...
    async createDailyPost() {
        ...
        const content = [
        'التقرير اليومي 📝:',
        'مطلوب منك يومياً تجاوب على الأسئلة دي بوضوح، مش عشان تحاسب نفسك، لكن عشان "تفهم" إيقاع عقلك وتصمم يومك بذكاء:',
        '',
        '🔋 **عن النهاردة (تشخيص طاقتك):**',
        '🔸 أنجزت إيه بتركيز عالي؟ (إيه مهام "العمل العميق" اللي خلصتها والحمد لله؟)',
        '🔸 مهمة أجلتها أو حسيت إنها تقيلة؟ (وهل حاولت تعملها في وقت طاقتك فيه كانت قليلة؟ ولا كانت محتاجة توضيح أكتر؟)',
        '🔸 المشتتات والعمل الضحل: وقتك ضاع أكتر في إيه النهاردة؟ (سوشيال ميديا، رسايل، مقاطعات) وإزاي ممكن نقللها بكرة؟',
        '🔸 شحنت طاقتك إزاي؟ (هل أديت لعقلك فرصة يفصل ويرتاح بدون شعور بالذنب؟)',
        '',
        '🎯 **عن بكرة (هندسة يومك الجديد):**',
        '🔸 إيه أهم 3 مهام هتعملهم بكرة؟ (ركز على الأهم، مش الأكتر)',
        '',
        '💡 **عشان خطتك تنجح وتتنفذ:**',
        'وأنت بتكتب مهام بكرة، انسى الجداول الصارمة والتزم بالقواعد دي:',
        '',
        '📌 اربط المهمة بالطاقة، مش بالساعة: هعمل المهمة الصعبة الفلانية في "وقت ذروة طاقتي"، وهخلي المهام الروتينية زي الرسايل والمكالمات في "وقت ركود طاقتي".',
        '📌 الجرعة الإبداعية الدنيا: لو المهمة شكلها يخض، اوعد نفسك تشتغل عليها 5 دقايق بس بكرة حتى لو بشكل فوضوي، عشان تكسر حاجز البداية وتدي إشارة لعقلك الباطن يشتغل عليها.',
        '📌 واقعية ومقاسة: المهمة لازم يكون ليها "قفلة" واضحة، عشان تقدر تقول (أنا خلصت).',
        '',
